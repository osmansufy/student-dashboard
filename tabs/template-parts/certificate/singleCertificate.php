        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-4">
                <div style="
                    ...
                    margin: 0 auto;
                    ">
                    <iframe src="<?php echo $certificate_url ?>#toolbar=0&navpanes=0" width="100%" height="100%"
                    ...
                    right:0; width:100%; height: 100%;
                     margin:0; padding:0; border:none">
                        <img alt="watermark"
                            src="<?php echo plugin_dir_url(dirname(__FILE__)) . '../../assets/images/water-mark.png' ?>" />
