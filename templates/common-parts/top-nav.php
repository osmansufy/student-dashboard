...
py-6
    ...
    <div class="container-fluid">
        <div class="d-flex w-100 justify-content-between">
            ...
            <ul class="d-none w-100 d-lg-flex justify-content-end align-items-center m-0">
            ...
            <a class="nav-link  d-lg-none" href="<?php echo get_site_url() . '/' ?>" style="max-width: 100px;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav flex-column nav-pills sa-top-nav d-lg-none " id="top-nav-bar" role="tablist"
                ...
                foreach ($navItems as $key => $value) {
                    ...
                    $icon = $value['icon'];
                ?>
                <li class="nav-item my-1" data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show"
                    ...
                    <a class="nav-link text-white    d-flex  <?php echo $active ?> " id=" v-pills-<?php echo $id ?>-tab"
                        ...
                        aria-controls="v-pills-<?php echo $id ?>" aria-selected="<?php echo $ariaSelected ?>">
