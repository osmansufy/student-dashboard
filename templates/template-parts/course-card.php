<div class="category-box" style="background-image: url('<?php echo $course->featured_image ?>');">
    ...
    <div class="popular-box-overlay">
        ...
        <div class="popular-overlay-btn-btm sa-btn_<?php echo $course->product_id ?>">
            <a target="_blank" href="<?php echo get_site_url() . '/course/' . $course->post_name ?>" role="button"
            ...
            ?>
            <a role="button" data-course-title="<?php echo $course->post_title ?>"
                data-product_id="<?php echo $course->product_id ?>" class="btn btn-outline-primary btn-lg extra-radius sal_add_to_cart_button
                                                    sa-cart-btn_<?php echo $course->product_id ?>
                                                    ">Add to Cart</a>
            <?php
            } else {
            ?>
            <a href="<?php echo wc_get_cart_url() ?>" target="_blank" role="button"
                class="btn sa-go-to-cart btn-outline-primary btn-lg extra-radius">
                Go to cart
            </a>
            <?php
            }
            ...
            <a href="<?php echo wc_get_cart_url() ?>" role="button" target="_blank"
                class="btn sa-go-to-cart btn-outline-primary btn-lg extra-radius  sa-gotoCart-btn_<?php echo $course->product_id ?>"
                style="display:none">
                Go to cart
            </a>
        </div>
