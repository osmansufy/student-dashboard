...
<div class="rewards-inner nav-item <?php if ($user_reward >= $rewards_need || $check_user_email_exist) {
    ...
    <a class="btn btn-primary">
        <img src="<?php echo plugin_dir_url(dirname(__FILE__)) . '../../assets/images/trophy-white.png' ?>" alt="trophy">X
        <?php echo $rewards_need ?>
    </a>

    <p id="sal_reward_btn_text" class="sal_coupon_<?php echo $coupon_code ?>"> <?php echo $coupon_description ?> ->
        <?php if ($check_user_email_exist) { ?>
            <span>Coupon code: <strong style="color: #0099ff"> <?php echo $coupon_code ?>
                </strong> --Unclaimed </span>
