  ...
  <nav class="navbar-primary">
    ...
    <ul class="navbar-primary-menu navbar-nav">
      ...
      ?>
      <li class="nav-item <?php echo $_SERVER['REQUEST_URI'] ===  "/wplms/learners-dashboard/" ? $activeClass : "" ?>">
      ...
      <li class="nav-item <?php echo $_SERVER['REQUEST_URI'] ===  "/wplms/my-courses-dashboard/" ? $activeClass : "" ?>"><a href="<?php echo get_site_url() . '/my-courses-dashboard' ?>"><span class="glyphicon glyphicon-envelope"></span><span class="nav-label">My Courses</span></a>
      </li>
      ...
      <li class="nav-item <?php echo is_page_template('learners-recommend-friends.php') ? $activeClass : "" ?>"><a href="<?php echo get_site_url() . '/learners-recommend-friends' ?>"><span class="glyphicon glyphicon-fire"></span><span class="nav-label">Refer & Earn Cash</span></a>
      </li>
      ...
      <li class="nav-item <?php echo is_page_template('student-portal.php') ? $activeClass : "" ?>"><a href="<?php echo get_site_url() . '/student-portal' ?>"><span class="glyphicon glyphicon-import"></span><span class="nav-label">Student Card</span></a>
      </li>
